...
namespace Cemsa_BackEnd
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<TCentral> TCentrals { get; set; } = null!;
        public DbSet<TCliente> TClientes { get; set; } = null!;
        public DbSet<TEstadoCentral> TEstadoCentrals { get; set; } = null!;
        public DbSet<TEstadoserviciosxCentral> TEstadoserviciosxCentrals { get; set; } = null!;
        public DbSet<TFumigacion> TFumigacions { get; set; } = null!;
        public DbSet<TServicio> TServicios { get; set; } = null!;
        public DbSet<TServiciosxcentral> TServiciosxcentrals { get; set; } = null!;
        public DbSet<TTipoDocumento> TTipoDocumentos { get; set; } = null!;
        public DbSet<TUsuario> TUsuarios { get; set; } = null!;
        public DbSet<Tmedicion> Tmedicions { get; set; } = null!;
        public DbSet<TAlarmaConfig> TAlarmaConfigs { get; set; } = null!;
        public DbSet<TAlarma> TAlarmas { get; set; } = null!;
